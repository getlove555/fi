...
cl =LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Ep2WWPiPuhgLZ5Vrdkh0.GYWw3ZbitY0o1/uzeahpya.s/UO87vWqwwKt6H9EkmzYGZbkN3b5LbYN9TwCc/XesI')
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EpvkTSfj9vEz6nZanSU5.TESQvOlTTcDJaUOAsbYLLq.UdT1tAvSw2ILqxFS0DHpu78rQ93cG71XNhtQN4Ux9xw')
ki.loginResult()

ki2 = LINETCR.LINE()
#ki2.login(qr=True)
ki2.login(token='EpvkTSfj9vEz6nZanSU5.TESQvOlTTcDJaUOAsbYLLq.UdT1tAvSw2ILqxFS0DHpu78rQ93cG71XNhtQN4Ux9xw')
ki2.loginResult()

ki3 = LINETCR.LINE()
#ki3.login(qr=True)
ki3.login(token='EpvkTSfj9vEz6nZanSU5.TESQvOlTTcDJaUOAsbYLLq.UdT1tAvSw2ILqxFS0DHpu78rQ93cG71XNhtQN4Ux9xw')
ki3.loginResult()

ki4 = LINETCR.LINE()
#ki4.login(qr=True)
ki4.login(token='EpvkTSfj9vEz6nZanSU5.TESQvOlTTcDJaUOAsbYLLq.UdT1tAvSw2ILqxFS0DHpu78rQ93cG71XNhtQN4Ux9xw')
ki4.loginResult()

ki5 = LINETCR.LINE()
#ki5.login(qr=True)
ki5.login(token='EpvkTSfj9vEz6nZanSU5.TESQvOlTTcDJaUOAsbYLLq.UdT1tAvSw2ILqxFS0DHpu78rQ93cG71XNhtQN4Ux9xw')
ki5.loginResult()
cl
...
admsa = "u832c16df30484f2d0ed7e5191001cf60"
admin = "u832c16df30484f2d0ed7e5191001cf60"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"selt bot by=*:K̲̲̅̅ ̲̲̅̅I̲̲̅̅ ̲̲̅̅E̲̲̅̅B̲̲̅̅O̲̅̅T̲̲̅̅ ̲̲̅̅L̲̲̅̅O̲̲̅̅V̲̲̅̅E̲̲̅̅L̲̲̅̅N̲̲̅̅E̲̲̅̅*.:｡ ✿*ﾟ‘ﾟ･✿.｡.:* *.",
    "lang":"JP",
